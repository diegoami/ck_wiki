...
finds it. Pushing to `images/` triggers that build — see *Rebuilding* below
for the other triggers, and for the one to send after uploading a **save**.
...
One call, and the build starts. **Do not rely on the `release` trigger for
